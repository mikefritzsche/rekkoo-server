...
COMMENT ON FUNCTION public.invite_user_to_group_cascade(p_group_id uuid, p_inviter_id uuid, p_invitee_id uuid, p_message text) IS 'Updated in migration 112 to ensure invitation_code is generated when creating group invitations';
