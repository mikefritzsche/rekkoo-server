-- Migration: Improve connection invitation messaging for group context
-- Description: Updates the messaging to make it clear that a group invitation will follow
-- Date: 2025-09-25
commit;
BEGIN;

-- Drop and recreate the trigger function with improved messaging
...
-- Create the updated function with better messaging
