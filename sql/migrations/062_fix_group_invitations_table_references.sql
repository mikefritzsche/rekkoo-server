-- Fix references to group_invitations table
-- Previous migrations incorrectly referenced collaboration_group_invitations instead of group_invitations

-- Update the invite_user_to_group_cascade function
...
BEGIN
    ...
    IF v_is_connected THEN
        ...
        FROM group_invitations  -- Fixed: was collaboration_group_invitations
        ...
        INSERT INTO group_invitations (  -- Fixed: was collaboration_group_invitations
            id,
            group_id,
            inviter_id,
            invitee_id,
...
COMMENT ON FUNCTION invite_user_to_group_cascade IS 'Updated in migration 062 to use correct table name (group_invitations not collaboration_group_invitations)';