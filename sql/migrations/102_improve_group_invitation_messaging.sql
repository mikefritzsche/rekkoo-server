-- Migration: Improve group invitation messaging
-- Description: Makes it clear that the group invitation is a separate action
-- Date: 2025-09-25
commit;
BEGIN;

-- Drop and recreate the trigger function with improved group invitation messaging
