-- Migration: Fix group invitation constraints and update trigger
-- Description: Adds missing unique constraint and fixes trigger ON CONFLICT clause
-- Date: 2025-09-25
commit;
BEGIN;
...
-- 2. Drop and recreate the trigger function with proper constraint handling
