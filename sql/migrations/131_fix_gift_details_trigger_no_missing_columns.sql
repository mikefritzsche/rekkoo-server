...
-- Fix maintain_gift_details to avoid referencing non-existent columns on list_items.
-- Only read gift fields from api_metadata/custom_fields payload, then upsert gift_details
-- and mirror the values back into api_metadata.
