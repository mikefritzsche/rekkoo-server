-- Migration: Fix group invitation to create pending instead of auto-accepting
-- Description: Updates trigger to create pending group invitation that requires manual acceptance
-- Date: 2025-09-25
commit;
BEGIN;

-- Drop and recreate the trigger function to create PENDING group invitations
    ...
    IF NEW.status = 'accepted' AND OLD.status = 'pending' THEN
        ...
        LOOP
            ...
            INSERT INTO group_invitations (
                ...
                v_invitation_code,
                COALESCE(pending_rec.message, 'You''ve been invited to join a group!'),
                'pending',  -- PENDING, not accepted
                'member',
                CURRENT_TIMESTAMP,
            ...
            DO UPDATE SET
                ...
                message = COALESCE(pending_rec.message, 'You''ve been invited to join a group!'),
                created_at = CURRENT_TIMESTAMP,
                expires_at = CURRENT_TIMESTAMP + INTERVAL '30 days';

            -- Create notification for the PENDING group invitation
