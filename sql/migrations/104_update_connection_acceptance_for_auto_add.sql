-- Migration: Update connection acceptance trigger to handle auto-add preferences
-- Description: Modifies the connection acceptance trigger to automatically add users to groups if they have auto-add enabled
-- Date: 2025-09-26
commit;
BEGIN;

-- Drop and recreate the trigger function with auto-add support
