-- Migration: Fix connection group invitation trigger with proper JSON syntax
-- Description: Updates the trigger to use proper PostgreSQL JSON operators
-- Date: 2025-09-25
...
DROP FUNCTION IF EXISTS handle_connection_group_invitation();
