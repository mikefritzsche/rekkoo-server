-- Improved trigger to automatically maintain gift_details
-- Handles both INSERT and UPDATE
-- Reads from api_metadata (primary) and custom_fields (fallback)
-- Updates existing gift_details records if they exist
...
BEGIN
    ...
    IF list_type_val = 'gift' OR list_type_val = 'gifts' THEN
