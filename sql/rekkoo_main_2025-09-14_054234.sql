...
CREATE TABLE public.user_privacy_settings (
    user_id uuid NOT NULL,
    privacy_mode character varying(20) DEFAULT 'standard'::character varying NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT privacy_mode_check CHECK (((privacy_mode)::text = ANY ((ARRAY['private'::character varying, 'standard'::character varying, 'public'::character varying])::text[])))
);
