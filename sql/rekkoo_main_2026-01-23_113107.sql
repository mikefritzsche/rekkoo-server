...
--
-- Name: contribution_status; Type: TYPE; Schema: public; Owner: admin
--
...
ALTER TYPE public.contribution_status OWNER TO admin;
...
--
-- Name: purchase_group_status; Type: TYPE; Schema: public; Owner: admin
--
...
ALTER TYPE public.purchase_group_status OWNER TO admin;
...
--
-- Name: can_invite_user_to_group(uuid, uuid); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.can_invite_user_to_group(p_inviter_id uuid, p_invitee_id uuid) RETURNS TABLE(can_invite boolean, reason character varying)
...
ALTER FUNCTION public.can_invite_user_to_group(p_inviter_id uuid, p_invitee_id uuid) OWNER TO admin;

--
-- Name: FUNCTION can_invite_user_to_group(p_inviter_id uuid, p_invitee_id uuid); Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON FUNCTION public.can_invite_user_to_group(p_inviter_id uuid, p_invitee_id uuid) IS 'Checks if a user can be invited to a group based on their privacy settings';


--
-- Name: can_invite_user_to_list(uuid, uuid, character varying); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.can_invite_user_to_list(p_inviter_id uuid, p_invitee_id uuid, p_list_type character varying DEFAULT NULL::character varying) RETURNS TABLE(can_invite boolean, reason character varying)
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
...
ALTER FUNCTION public.can_invite_user_to_list(p_inviter_id uuid, p_invitee_id uuid, p_list_type character varying) OWNER TO admin;

--
-- Name: FUNCTION can_invite_user_to_list(p_inviter_id uuid, p_invitee_id uuid, p_list_type character varying); Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON FUNCTION public.can_invite_user_to_list(p_inviter_id uuid, p_invitee_id uuid, p_list_type character varying) IS 'Checks if a user can be invited to a list based on their privacy settings';
...
COMMENT ON FUNCTION public.can_send_connection_request(p_sender_id uuid, p_recipient_id uuid) IS 'Checks if a user can send a connection request to another user, respecting privacy settings';
...
--
-- Name: cleanup_old_processed_invitations(); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.cleanup_old_processed_invitations() RETURNS integer
    LANGUAGE plpgsql
    AS $$
      DECLARE
...
ALTER FUNCTION public.cleanup_old_processed_invitations() OWNER TO admin;
...
COMMENT ON FUNCTION public.create_connection_invitation_notification() IS 'Creates notifications for connection invitations. For group invitations, clearly indicates whether user will be auto-added or receive separate invitation.';
...
--
-- Name: create_gift_details_for_gift_items(); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.create_gift_details_for_gift_items() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    list_type_val text;
...
ALTER FUNCTION public.create_gift_details_for_gift_items() OWNER TO admin;
...
--
-- Name: delete_processed_group_invitations(); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.delete_processed_group_invitations() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
      BEGIN
...
ALTER FUNCTION public.delete_processed_group_invitations() OWNER TO admin;
...
--
-- Name: get_user_auto_add_preferences(uuid); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.get_user_auto_add_preferences(p_user_id uuid) RETURNS jsonb
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
...
ALTER FUNCTION public.get_user_auto_add_preferences(p_user_id uuid) OWNER TO admin;

--
-- Name: FUNCTION get_user_auto_add_preferences(p_user_id uuid); Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON FUNCTION public.get_user_auto_add_preferences(p_user_id uuid) IS 'Returns user''s auto-add preferences, respecting explicit choices for standard/private modes, enforcing only for ghost/public modes';
...
COMMENT ON FUNCTION public.invite_user_to_group_cascade(p_group_id uuid, p_inviter_id uuid, p_invitee_id uuid, p_message text) IS 'Updated in migration 120 to allow re-sending group invitations by reusing existing records';
...
--
-- Name: maintain_gift_details(); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.maintain_gift_details() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    list_type_val text;
...
ALTER FUNCTION public.maintain_gift_details() OWNER TO admin;

--
-- Name: maintain_list_item_details(); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.maintain_list_item_details() RETURNS trigger
    LANGUAGE plpgsql
    AS $_$
DECLARE
    list_type_val text;
...
ALTER FUNCTION public.maintain_list_item_details() OWNER TO admin;

--
-- Name: maintain_movie_details(); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.maintain_movie_details() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    list_type_val text;
...
ALTER FUNCTION public.maintain_movie_details() OWNER TO admin;
...
--
-- Name: run_cleanup_processed_invitations(); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.run_cleanup_processed_invitations() RETURNS TABLE(deleted_count integer)
    LANGUAGE plpgsql
    AS $$
      BEGIN
...
ALTER FUNCTION public.run_cleanup_processed_invitations() OWNER TO admin;
...
--
-- Name: user_allows_automatic_group_additions(uuid); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.user_allows_automatic_group_additions(p_user_id uuid) RETURNS boolean
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
    v_auto_add_preferences jsonb;
...
ALTER FUNCTION public.user_allows_automatic_group_additions(p_user_id uuid) OWNER TO admin;

--
-- Name: FUNCTION user_allows_automatic_group_additions(p_user_id uuid); Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON FUNCTION public.user_allows_automatic_group_additions(p_user_id uuid) IS 'Returns true if user allows automatic group additions. Respects explicit user preferences over approval requirements.';


--
-- Name: user_allows_automatic_list_additions(uuid); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.user_allows_automatic_list_additions(p_user_id uuid) RETURNS boolean
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
    v_auto_add_preferences jsonb;
...
ALTER FUNCTION public.user_allows_automatic_list_additions(p_user_id uuid) OWNER TO admin;

--
-- Name: FUNCTION user_allows_automatic_list_additions(p_user_id uuid); Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON FUNCTION public.user_allows_automatic_list_additions(p_user_id uuid) IS 'Returns true if user allows automatic list additions. Respects explicit user preferences over approval requirements.';
...
--
-- Name: user_requires_approval_for_additions(uuid); Type: FUNCTION; Schema: public; Owner: admin
--

CREATE FUNCTION public.user_requires_approval_for_additions(p_user_id uuid) RETURNS boolean
    LANGUAGE plpgsql STABLE
    AS $$
DECLARE
...
ALTER FUNCTION public.user_requires_approval_for_additions(p_user_id uuid) OWNER TO admin;

--
-- Name: FUNCTION user_requires_approval_for_additions(p_user_id uuid); Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON FUNCTION public.user_requires_approval_for_additions(p_user_id uuid) IS 'Checks if a user requires approval for all group/list additions';
...
--
-- Name: beta_waitlist; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.beta_waitlist OWNER TO admin;

--
-- Name: TABLE beta_waitlist; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON TABLE public.beta_waitlist IS 'Stores email addresses requesting beta access invitations.';


--
-- Name: COLUMN beta_waitlist.status; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN public.beta_waitlist.status IS 'Current state of the request: pending, invited, or notified.';


--
-- Name: COLUMN beta_waitlist.metadata; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN public.beta_waitlist.metadata IS 'Additional JSON metadata such as source, user agent, or IP address.';
...
--
-- Name: bug_reports; Type: TABLE; Schema: public; Owner: admin
--
...
CREATE TABLE public.bug_reports (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT bug_reports_category_check CHECK ((category = ANY (ARRAY['ui'::text, 'performance'::text, 'sync'::text, 'data'::text, 'other'::text]))),
    CONSTRAINT bug_reports_channel_check CHECK ((channel = ANY (ARRAY['web'::text, 'ios'::text, 'android'::text, 'desktop'::text, 'api'::text]))),
    CONSTRAINT bug_reports_impact_check CHECK ((impact = ANY (ARRAY['blocker'::text, 'high'::text, 'medium'::text, 'low'::text]))),
    CONSTRAINT bug_reports_status_check CHECK ((status = ANY (ARRAY['open'::text, 'triaged'::text, 'in_progress'::text, 'resolved'::text, 'wont_fix'::text, 'duplicate'::text])))
);


ALTER TABLE public.bug_reports OWNER TO admin;
...
--
-- Name: checklist_details; Type: TABLE; Schema: public; Owner: admin
--
...
CREATE TABLE public.checklist_details (
    ...
    deleted_at timestamp with time zone,
    CONSTRAINT checklist_details_priority_check CHECK ((priority = ANY (ARRAY['low'::text, 'medium'::text, 'high'::text])))
);
...
--
-- Name: checklist_history; Type: TABLE; Schema: public; Owner: admin
--
...
CREATE TABLE public.checklist_history (
    ...
    notes text,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT checklist_history_action_check CHECK ((action = ANY (ARRAY['completed'::text, 'reset'::text, 'skipped'::text, 'deferred'::text, 'edited'::text])))
);
...
CREATE TABLE public.collaboration_group_members (
    ...
    invited_by uuid,
    CONSTRAINT collaboration_group_members_status_check CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'inactive'::character varying, 'pending'::character varying, 'removed'::character varying])::text[])))
);
...
--
-- Name: COLUMN collaboration_group_members.status; Type: COMMENT; Schema: public; Owner: admin
--
...
--
-- Name: COLUMN collaboration_group_members.invited_by; Type: COMMENT; Schema: public; Owner: admin
--
...
--
-- Name: gift_contributions; Type: TABLE; Schema: public; Owner: admin
--
...
CREATE TABLE public.gift_contributions (
    ...
    contribution_quantity integer DEFAULT 0 NOT NULL,
    status public.contribution_status DEFAULT 'pledged'::public.contribution_status NOT NULL,
    note text,
    ...
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    deleted_at timestamp with time zone,
    CONSTRAINT gift_contributions_amount_or_quantity CHECK (((contribution_cents IS NOT NULL) OR (contribution_quantity > 0))),
    CONSTRAINT gift_contributions_cents_positive CHECK (((contribution_cents IS NULL) OR (contribution_cents >= 0))),
    CONSTRAINT gift_contributions_contribution_quantity_check CHECK ((contribution_quantity >= 0))
);


ALTER TABLE public.gift_contributions OWNER TO admin;
...
--
-- Name: gift_purchase_groups; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.gift_purchase_groups (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    item_id uuid NOT NULL,
    list_id uuid NOT NULL,
    created_by uuid,
    ...
    status public.purchase_group_status DEFAULT 'open'::public.purchase_group_status NOT NULL,
    is_quantity_based boolean DEFAULT false NOT NULL,
    notes text,
    ...
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    deleted_at timestamp with time zone,
    CONSTRAINT gift_purchase_groups_currency_required CHECK ((is_quantity_based OR (currency_code IS NOT NULL))),
    CONSTRAINT gift_purchase_groups_target_cents_positive CHECK (((target_cents IS NULL) OR (target_cents >= 0))),
    CONSTRAINT gift_purchase_groups_target_quantity_check CHECK ((target_quantity >= 0)),
    CONSTRAINT gift_purchase_groups_target_required CHECK ((is_quantity_based OR (target_cents IS NOT NULL)))
);


ALTER TABLE public.gift_purchase_groups OWNER TO admin;
...
CREATE TABLE public.group_invitations (
    ...
    status character varying(20) DEFAULT 'pending'::character varying NOT NULL,
    invitation_code character varying(100) DEFAULT lower(concat('GI-', replace((gen_random_uuid())::text, '-'::text, ''::text))) NOT NULL,
    message text,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    responded_at timestamp with time zone,
    expires_at timestamp with time zone DEFAULT (CURRENT_TIMESTAMP + '30 days'::interval) NOT NULL,
...
CREATE TABLE public.invitations (
    ...
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    deleted_at timestamp with time zone,
    source character varying(50) DEFAULT 'user_generated'::character varying,
...
COMMENT ON COLUMN public.invitations.metadata IS 'Additional invitation metadata as JSONB';


--
-- Name: COLUMN invitations.source; Type: COMMENT; Schema: public; Owner: admin
--

COMMENT ON COLUMN public.invitations.source IS 'Source of the invitation: user_generated, beta_program, etc.';
...
CREATE TABLE public.list_items (
    ...
    tags text[],
    gift_detail_id uuid,
    checklist_detail_id uuid,
    packing_detail_id uuid,
...
END) +
CASE
    WHEN (checklist_detail_id IS NOT NULL) THEN 1
    ELSE 0
END) +
CASE
    WHEN (packing_detail_id IS NOT NULL) THEN 1
    ELSE 0
END) <= 1))
);
...
--
-- Name: packing_details; Type: TABLE; Schema: public; Owner: admin
--
...
CREATE TABLE public.packing_details (
    ...
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    deleted_at timestamp with time zone,
    CONSTRAINT packing_details_size_check CHECK ((size = ANY (ARRAY['small'::text, 'medium'::text, 'large'::text, 'extra-large'::text])))
);
...
--
-- Name: secret_santa_guest_invites; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.secret_santa_guest_invites (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    round_id uuid NOT NULL,
    email text NOT NULL,
    invite_token uuid DEFAULT public.uuid_generate_v4() NOT NULL,
...
ALTER TABLE public.secret_santa_guest_invites OWNER TO admin;

--
-- Name: secret_santa_pairings; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE public.secret_santa_pairings OWNER TO admin;

--
-- Name: secret_santa_round_participants; Type: TABLE; Schema: public; Owner: admin
--

CREATE TABLE public.secret_santa_round_participants (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    round_id uuid NOT NULL,
    user_id uuid NOT NULL,
    ...
    wishlist_share_consented_at timestamp with time zone,
    updated_at timestamp with time zone DEFAULT now()
);


ALTER TABLE public.secret_santa_round_participants OWNER TO admin;

--
-- Name: secret_santa_rounds; Type: TABLE; Schema: public; Owner: admin
--
...
CREATE TABLE public.secret_santa_rounds (
    ...
    currency character varying(16) DEFAULT 'USD'::character varying,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    signup_cutoff_date timestamp with time zone,
    auto_draw_enabled boolean DEFAULT false NOT NULL,
    notify_via_push boolean DEFAULT true NOT NULL,
    notify_via_email boolean DEFAULT false NOT NULL,
    exclusion_pairs jsonb DEFAULT '[]'::jsonb,
    CONSTRAINT secret_santa_rounds_status_check CHECK ((status = ANY (ARRAY['draft'::text, 'active'::text, 'closed'::text])))
);


ALTER TABLE public.secret_santa_rounds OWNER TO admin;
...
--
-- Name: beta_waitlist beta_waitlist_email_key; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: beta_waitlist beta_waitlist_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: bug_reports bug_reports_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: bug_reports bug_reports_reference_code_key; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.bug_reports
    ADD CONSTRAINT bug_reports_reference_code_key UNIQUE (reference_code);
...
--
-- Name: checklist_details checklist_details_list_item_id_unique; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.checklist_details
    ADD CONSTRAINT checklist_details_list_item_id_unique UNIQUE (list_item_id);


--
-- Name: checklist_details checklist_details_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.checklist_details
    ADD CONSTRAINT checklist_details_pkey PRIMARY KEY (id);


--
-- Name: checklist_history checklist_history_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: gift_contributions gift_contributions_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
...
--
-- Name: gift_purchase_groups gift_purchase_groups_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.gift_purchase_groups
    ADD CONSTRAINT gift_purchase_groups_pkey PRIMARY KEY (id);
...
--
-- Name: packing_details packing_details_list_item_id_unique; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.packing_details
    ADD CONSTRAINT packing_details_list_item_id_unique UNIQUE (list_item_id);


--
-- Name: packing_details packing_details_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.packing_details
    ADD CONSTRAINT packing_details_pkey PRIMARY KEY (id);
...
--
-- Name: secret_santa_guest_invites secret_santa_guest_invites_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_guest_invites
    ADD CONSTRAINT secret_santa_guest_invites_pkey PRIMARY KEY (id);


--
-- Name: secret_santa_guest_invites secret_santa_guest_invites_round_id_email_key; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_guest_invites
    ADD CONSTRAINT secret_santa_guest_invites_round_id_email_key UNIQUE (round_id, email);


--
-- Name: secret_santa_pairings secret_santa_pairings_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_pairings
    ADD CONSTRAINT secret_santa_pairings_pkey PRIMARY KEY (id);


--
-- Name: secret_santa_pairings secret_santa_pairings_round_id_giver_user_id_key; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_pairings
    ADD CONSTRAINT secret_santa_pairings_round_id_giver_user_id_key UNIQUE (round_id, giver_user_id);


--
-- Name: secret_santa_round_participants secret_santa_round_participants_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_round_participants
    ADD CONSTRAINT secret_santa_round_participants_pkey PRIMARY KEY (id);


--
-- Name: secret_santa_round_participants secret_santa_round_participants_round_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_round_participants
    ADD CONSTRAINT secret_santa_round_participants_round_id_user_id_key UNIQUE (round_id, user_id);


--
-- Name: secret_santa_rounds secret_santa_rounds_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_rounds
    ADD CONSTRAINT secret_santa_rounds_pkey PRIMARY KEY (id);
...
--
-- Name: idx_beta_waitlist_status; Type: INDEX; Schema: public; Owner: admin
--
...
--
-- Name: idx_checklist_details_assigned_to; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_checklist_details_assigned_to ON public.checklist_details USING btree (assigned_to);


--
-- Name: idx_checklist_details_completed; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_checklist_details_completed ON public.checklist_details USING btree (completed);


--
-- Name: idx_checklist_details_due_date; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_checklist_details_due_date ON public.checklist_details USING btree (due_date);


--
-- Name: idx_checklist_history_item; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_checklist_history_item ON public.checklist_history USING btree (item_id);


--
-- Name: idx_checklist_history_list; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_checklist_history_list ON public.checklist_history USING btree (list_id);


--
-- Name: idx_checklist_history_performed_at; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_checklist_history_performed_at ON public.checklist_history USING btree (performed_at);
...
--
-- Name: idx_collaboration_group_members_invited_by; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_collaboration_group_members_invited_by ON public.collaboration_group_members USING btree (invited_by);


--
-- Name: idx_collaboration_group_members_status; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_collaboration_group_members_status ON public.collaboration_group_members USING btree (status);
...
--
-- Name: idx_gift_contributions_contributor; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_gift_contributions_contributor ON public.gift_contributions USING btree (contributor_id) WHERE (deleted_at IS NULL);


--
-- Name: idx_gift_contributions_group; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_gift_contributions_group ON public.gift_contributions USING btree (group_id) WHERE (deleted_at IS NULL);


--
-- Name: idx_gift_contributions_status; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_gift_contributions_status ON public.gift_contributions USING btree (status) WHERE (deleted_at IS NULL);
...
--
-- Name: idx_gift_purchase_groups_list_id; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_gift_purchase_groups_list_id ON public.gift_purchase_groups USING btree (list_id) WHERE (deleted_at IS NULL);


--
-- Name: idx_gift_purchase_groups_status; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_gift_purchase_groups_status ON public.gift_purchase_groups USING btree (status) WHERE (deleted_at IS NULL);


--
-- Name: idx_gift_reservations_active_group; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_gift_reservations_active_group ON public.gift_reservations USING btree (active_purchase_group_id) WHERE (deleted_at IS NULL);
...
--
-- Name: idx_invitations_metadata_source; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_invitations_metadata_source ON public.invitations USING gin (metadata) WHERE ((metadata ->> 'source'::text) = 'beta_program'::text);


--
-- Name: idx_invitations_source; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_invitations_source ON public.invitations USING btree (source) WHERE ((source)::text = 'beta_program'::text);
...
--
-- Name: idx_list_items_checklist_detail_id; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_list_items_checklist_detail_id ON public.list_items USING btree (checklist_detail_id);
...
--
-- Name: idx_list_items_packing_detail_id; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_list_items_packing_detail_id ON public.list_items USING btree (packing_detail_id);
...
--
-- Name: idx_packing_details_category; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_packing_details_category ON public.packing_details USING btree (category);


--
-- Name: idx_packing_details_location; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_packing_details_location ON public.packing_details USING btree (location);


--
-- Name: idx_packing_details_packed; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_packing_details_packed ON public.packing_details USING btree (packed);
...
--
-- Name: idx_secret_santa_guest_invites_round; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_secret_santa_guest_invites_round ON public.secret_santa_guest_invites USING btree (round_id);


--
-- Name: idx_secret_santa_pairings_round; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_secret_santa_pairings_round ON public.secret_santa_pairings USING btree (round_id);


--
-- Name: idx_secret_santa_participants_list; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_secret_santa_participants_list ON public.secret_santa_round_participants USING btree (list_id);


--
-- Name: idx_secret_santa_participants_round; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_secret_santa_participants_round ON public.secret_santa_round_participants USING btree (round_id);


--
-- Name: idx_secret_santa_rounds_list_status; Type: INDEX; Schema: public; Owner: admin
--

CREATE INDEX idx_secret_santa_rounds_list_status ON public.secret_santa_rounds USING btree (list_id, status);
...
--
-- Name: uniq_gift_contributions_group_contributor; Type: INDEX; Schema: public; Owner: admin
--

CREATE UNIQUE INDEX uniq_gift_contributions_group_contributor ON public.gift_contributions USING btree (group_id, contributor_id) WHERE ((deleted_at IS NULL) AND (contributor_id IS NOT NULL));


--
-- Name: uniq_gift_purchase_groups_item_active; Type: INDEX; Schema: public; Owner: admin
--

CREATE UNIQUE INDEX uniq_gift_purchase_groups_item_active ON public.gift_purchase_groups USING btree (item_id) WHERE ((deleted_at IS NULL) AND (status = ANY (ARRAY['open'::public.purchase_group_status, 'locked'::public.purchase_group_status])));
...
--
-- Name: collaboration_group_members auto_delete_processed_invitations; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER auto_delete_processed_invitations AFTER INSERT ON public.collaboration_group_members FOR EACH ROW EXECUTE FUNCTION public.delete_processed_group_invitations();
...
--
-- Name: list_items maintain_gift_details_trigger; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER maintain_gift_details_trigger BEFORE INSERT OR UPDATE ON public.list_items FOR EACH ROW EXECUTE FUNCTION public.maintain_gift_details();


--
-- Name: list_items maintain_list_item_details_trigger; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER maintain_list_item_details_trigger BEFORE INSERT OR UPDATE ON public.list_items FOR EACH ROW EXECUTE FUNCTION public.maintain_list_item_details();
...
--
-- Name: gift_contributions trg_gift_contributions_changes; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER trg_gift_contributions_changes AFTER INSERT OR DELETE OR UPDATE ON public.gift_contributions FOR EACH ROW EXECUTE FUNCTION public.track_changes();


--
-- Name: gift_purchase_groups trg_gift_purchase_groups_changes; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER trg_gift_purchase_groups_changes AFTER INSERT OR DELETE OR UPDATE ON public.gift_purchase_groups FOR EACH ROW EXECUTE FUNCTION public.track_changes();
...
--
-- Name: secret_santa_guest_invites trg_secret_santa_invites_changes; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER trg_secret_santa_invites_changes AFTER INSERT OR DELETE OR UPDATE ON public.secret_santa_guest_invites FOR EACH ROW EXECUTE FUNCTION public.track_changes();


--
-- Name: secret_santa_pairings trg_secret_santa_pairings_changes; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER trg_secret_santa_pairings_changes AFTER INSERT OR DELETE OR UPDATE ON public.secret_santa_pairings FOR EACH ROW EXECUTE FUNCTION public.track_changes();


--
-- Name: secret_santa_round_participants trg_secret_santa_participants_changes; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER trg_secret_santa_participants_changes AFTER INSERT OR DELETE OR UPDATE ON public.secret_santa_round_participants FOR EACH ROW EXECUTE FUNCTION public.track_changes();


--
-- Name: secret_santa_rounds trg_secret_santa_rounds_changes; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER trg_secret_santa_rounds_changes AFTER INSERT OR DELETE OR UPDATE ON public.secret_santa_rounds FOR EACH ROW EXECUTE FUNCTION public.track_changes();
...
--
-- Name: checklist_details update_checklist_details_updated_at; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER update_checklist_details_updated_at BEFORE UPDATE ON public.checklist_details FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: gift_contributions update_gift_contributions_updated_at; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER update_gift_contributions_updated_at BEFORE UPDATE ON public.gift_contributions FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: gift_purchase_groups update_gift_purchase_groups_updated_at; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER update_gift_purchase_groups_updated_at BEFORE UPDATE ON public.gift_purchase_groups FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: packing_details update_packing_details_updated_at; Type: TRIGGER; Schema: public; Owner: admin
--

CREATE TRIGGER update_packing_details_updated_at BEFORE UPDATE ON public.packing_details FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: bug_reports bug_reports_assignee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.bug_reports
    ADD CONSTRAINT bug_reports_assignee_id_fkey FOREIGN KEY (assignee_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: bug_reports bug_reports_reported_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.bug_reports
    ADD CONSTRAINT bug_reports_reported_by_fkey FOREIGN KEY (reported_by) REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: checklist_details checklist_details_list_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.checklist_details
    ADD CONSTRAINT checklist_details_list_item_id_fkey FOREIGN KEY (list_item_id) REFERENCES public.list_items(id) ON DELETE CASCADE;


--
-- Name: checklist_history checklist_history_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.checklist_history
    ADD CONSTRAINT checklist_history_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.list_items(id) ON DELETE CASCADE;


--
-- Name: checklist_history checklist_history_list_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.checklist_history
    ADD CONSTRAINT checklist_history_list_id_fkey FOREIGN KEY (list_id) REFERENCES public.lists(id) ON DELETE CASCADE;
...
--
-- Name: gift_reservations fk_gift_reservations_active_group; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.gift_reservations
    ADD CONSTRAINT fk_gift_reservations_active_group FOREIGN KEY (active_purchase_group_id) REFERENCES public.gift_purchase_groups(id) ON DELETE SET NULL;
...
--
-- Name: secret_santa_round_participants fk_secret_santa_participants_list; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_round_participants
    ADD CONSTRAINT fk_secret_santa_participants_list FOREIGN KEY (list_id) REFERENCES public.lists(id) ON DELETE CASCADE;
...
--
-- Name: gift_contributions gift_contributions_contributor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.gift_contributions
    ADD CONSTRAINT gift_contributions_contributor_id_fkey FOREIGN KEY (contributor_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: gift_contributions gift_contributions_group_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.gift_contributions
    ADD CONSTRAINT gift_contributions_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.gift_purchase_groups(id) ON DELETE CASCADE;


--
-- Name: gift_contributions gift_contributions_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.gift_contributions
    ADD CONSTRAINT gift_contributions_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.list_items(id) ON DELETE CASCADE;


--
-- Name: gift_contributions gift_contributions_list_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.gift_contributions
    ADD CONSTRAINT gift_contributions_list_id_fkey FOREIGN KEY (list_id) REFERENCES public.lists(id) ON DELETE CASCADE;


--
-- Name: gift_contributions gift_contributions_source_reservation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.gift_contributions
    ADD CONSTRAINT gift_contributions_source_reservation_id_fkey FOREIGN KEY (source_reservation_id) REFERENCES public.gift_reservations(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.gift_details
    ADD CONSTRAINT gift_details_list_item_id_fkey FOREIGN KEY (list_item_id) REFERENCES public.list_items(id) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;


--
-- Name: gift_purchase_groups gift_purchase_groups_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.gift_purchase_groups
    ADD CONSTRAINT gift_purchase_groups_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: gift_purchase_groups gift_purchase_groups_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.gift_purchase_groups
    ADD CONSTRAINT gift_purchase_groups_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.list_items(id) ON DELETE CASCADE;


--
-- Name: gift_purchase_groups gift_purchase_groups_list_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.gift_purchase_groups
    ADD CONSTRAINT gift_purchase_groups_list_id_fkey FOREIGN KEY (list_id) REFERENCES public.lists(id) ON DELETE CASCADE;
...
--
-- Name: list_items list_items_checklist_detail_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.list_items
    ADD CONSTRAINT list_items_checklist_detail_id_fkey FOREIGN KEY (checklist_detail_id) REFERENCES public.checklist_details(id) ON DELETE SET NULL;
...
--
-- Name: list_items list_items_packing_detail_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.list_items
    ADD CONSTRAINT list_items_packing_detail_id_fkey FOREIGN KEY (packing_detail_id) REFERENCES public.packing_details(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.movie_details
    ADD CONSTRAINT movie_details_list_item_id_fkey FOREIGN KEY (list_item_id) REFERENCES public.list_items(id) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: packing_details packing_details_list_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.packing_details
    ADD CONSTRAINT packing_details_list_item_id_fkey FOREIGN KEY (list_item_id) REFERENCES public.list_items(id) ON DELETE CASCADE;
...
--
-- Name: secret_santa_guest_invites secret_santa_guest_invites_round_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_guest_invites
    ADD CONSTRAINT secret_santa_guest_invites_round_id_fkey FOREIGN KEY (round_id) REFERENCES public.secret_santa_rounds(id) ON DELETE CASCADE;


--
-- Name: secret_santa_pairings secret_santa_pairings_giver_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_pairings
    ADD CONSTRAINT secret_santa_pairings_giver_user_id_fkey FOREIGN KEY (giver_user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: secret_santa_pairings secret_santa_pairings_recipient_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_pairings
    ADD CONSTRAINT secret_santa_pairings_recipient_user_id_fkey FOREIGN KEY (recipient_user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: secret_santa_pairings secret_santa_pairings_round_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_pairings
    ADD CONSTRAINT secret_santa_pairings_round_id_fkey FOREIGN KEY (round_id) REFERENCES public.secret_santa_rounds(id) ON DELETE CASCADE;


--
-- Name: secret_santa_round_participants secret_santa_round_participants_round_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_round_participants
    ADD CONSTRAINT secret_santa_round_participants_round_id_fkey FOREIGN KEY (round_id) REFERENCES public.secret_santa_rounds(id) ON DELETE CASCADE;


--
-- Name: secret_santa_round_participants secret_santa_round_participants_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_round_participants
    ADD CONSTRAINT secret_santa_round_participants_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: secret_santa_rounds secret_santa_rounds_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_rounds
    ADD CONSTRAINT secret_santa_rounds_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);


--
-- Name: secret_santa_rounds secret_santa_rounds_list_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.secret_santa_rounds
    ADD CONSTRAINT secret_santa_rounds_list_id_fkey FOREIGN KEY (list_id) REFERENCES public.lists(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.spotify_item_details
    ADD CONSTRAINT spotify_item_details_list_item_id_fkey FOREIGN KEY (list_item_id) REFERENCES public.list_items(id) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: tv_details tv_details_list_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.tv_details
    ADD CONSTRAINT tv_details_list_item_id_fkey FOREIGN KEY (list_item_id) REFERENCES public.list_items(id) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
